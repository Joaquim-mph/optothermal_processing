"""
Drift-corrected photoresponse comparison for chips 72/74/75/81.
...
Run from repo root:
    python scripts/compare_corrected_photoresponse_72_74_75_81.py
...
def main() -> None:
    ...
    base = OUTPUT_DIR / "alisson72_74_75_81_corrected_photoresponse_vs_wavelength"
