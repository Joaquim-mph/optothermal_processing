"""
IVg analysis plots for Alisson80 on 2026-05-04.
...
Triplets (OFF, ON, OFF, wavelength):
    (122, 123, 124, 365 nm)
    (125, 126, 127, 385 nm)
    (136, 137, 138, 405 nm)   # redo: first attempt (128, 129, 130) was trash (source disconnected)
    (139, 140, 141, 455 nm)   # redo: first attempt (131, 132, 133) was trash (source disconnected)

Run from the repo root:
    python scripts/plot_ivg_photocurrent_alisson80_2026-05-04.py
"""
