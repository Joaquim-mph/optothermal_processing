"""
Vt Preset Selector Page.

Lists available Vt presets for quick configuration.
"""
...
from src.plotting.vt_presets import PRESETS, preset_summary

if TYPE_CHECKING:
    from src.gui.app import MainWindow


class VtPresetSelectorPage(QWidget):
    """Vt preset selection page."""
    ...
    def on_enter(self, **kwargs) -> None:
        if self._window.session.chip_number is not None:
            ...
            self._subtitle.setText(f"Chip: {chip_name}  |  Plot: Vt")
